...
MODEL_PATH = 'epl_yellow_cards_model.pkl'
...
# Train model
print("Starting hyperparameter tuning for Total Yellow Cards model...")
...
print("\nTotal Yellow Cards Model Evaluation:")
