...
MODEL_PATH = 'epl_corners_model.pkl'
...
# We exclude betting odds features as we don't have specific odds for corners
features = [
...
# Train model
print("Starting hyperparameter tuning for Total Corners model...")
...
print("\nTotal Corners Model Evaluation:")
