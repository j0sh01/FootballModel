...
MODEL_PATH = 'epl_asian_handicap_model.pkl'
...
features = [
    ...
    'HomeElo', 'AwayElo',
    'NormProb_AHH', 'NormProb_AHA'
]
target = 'AsianHandicapOutcome'
...
# Train model
print("Starting hyperparameter tuning for Asian Handicap model...")
...
print("Asian Handicap Model Evaluation:")
print(f"Accuracy: {accuracy_score(y_test, y_pred):.2f}")
print("\nClassification Report:")
print(classification_report(y_test, y_pred, target_names=['Away Covers', 'Home Covers']))
